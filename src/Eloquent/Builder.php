...
use Redico\Aggregations\Bucket\Filter;
use Illuminate\Database\Eloquent\Model;
use Redico\Query\Builder as BaseBuilder;
use Illuminate\Contracts\Support\Arrayable;
use Redico\Eloquent\Concerns\LoadsAggregates;
use Redico\Eloquent\Concerns\QueriesRelationships;
 ...
 * 
 * @mixin \Redico\Query\Builder
 * @method static \Redico\Eloquent\Builder where()
 */
class Builder extends EloquentBuilder
{
    ...
    public function setModel(Model $model)
    {
        ...
        $this->query->indexConfig($model::indexConfig());
     ...
     *
     * @return \Redico\Query\Builder
     */
    public function toBase()
    {
        return parent::toBase()
            ->indexConfig($this->model::indexConfig());
    }
     ...
     *
     * @return null|\Redico\Query\Response\Collection|\Illuminate\Database\Eloquent\Model|static|static[]
     */
     ...
     * @param array|string                                  $columns
     *
     * @return \Redico\Query\Response\Collection
     */
     ...
     * @param array|string $columns
     *
     * @return \Redico\Query\Response\Collection|static[]
     */
    public function get($columns = ['*'])
    {
        ...
        $response = $this->toBase()->get($columns);
    ...
    public function insert(array $values)
    {
        ...
        $insertValues = collect($values)
            ->map(fn (array|Model $value): array => match (true) {
                $value instanceof Model => [
                    '_key' => $value->getTable() . '::' . $value->getKey(),
                    ...$value->getDirty(),
                ],
                is_array($value) => [
                    '_key' => Arr::get($value, '_key', $this->model->getTable() . '::' . Arr::get($value, $this->model->getKeyName())),
                    ...$value
                ],
            })
            ->all();
