...
use Redico\Aggregations\Metric\Min;
use Redico\Aggregations\Metric\Sum;
use Illuminate\Pagination\Paginator;
use Illuminate\Support\LazyCollection;
use Redico\Query\Builder\HasPostFilter;
use Redico\Query\Builder\ExcludesColumns;
use Redico\Query\Builder\HasAggregations;
...
class Builder extends BaseBuilder
{
    ...
    public function indexConfig(Index $config): static
    {
    ...
    public function update(array|Script $values)
    {
        ...
        if (isset($this->index_id) && isset($this->model_id)) {
            $values['_key'] = $this->index_id . '::' . $this->model_id;
        ...
        throw new Exception("Redis does not support update by query");
